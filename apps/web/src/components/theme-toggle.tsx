...
const options: { value: Choice; short: string; label: string; icon: React.ReactNode }[] = [
  { value: "system", short: "Auto", label: "Tema do sistema", icon: <path d="M3 5.5A1.5 1.5 0 0 1 4.5 4h11A1.5 1.5 0 0 1 17 5.5V12a1.5 1.5 0 0 1-1.5 1.5h-11A1.5 1.5 0 0 1 3 12V5.5ZM7.5 16.5h5M10 13.5v3" /> },
  { value: "light", short: "Claro", label: "Tema claro", icon: <><circle cx="10" cy="10" r="3.2" /><path d="M10 2.5v1.6M10 15.9v1.6M2.5 10h1.6M15.9 10h1.6M4.7 4.7l1.1 1.1M14.2 14.2l1.1 1.1M4.7 15.3l1.1-1.1M14.2 5.8l1.1-1.1" /></> },
  { value: "dark", short: "Escuro", label: "Tema escuro", icon: <path d="M16.2 12.6A6.8 6.8 0 0 1 7.4 3.8a6.8 6.8 0 1 0 8.8 8.8Z" /> },
];
...
export function ThemeToggle({ className = "", labels = false }: { className?: string; labels?: boolean }) {
  ...
  return (
    <div className={`theme-toggle ${labels ? "labeled" : ""} ${className}`} role="radiogroup" aria-label="Tema">
      {options.map((option) => (
        <button
          key={option.value}
          type="button"
