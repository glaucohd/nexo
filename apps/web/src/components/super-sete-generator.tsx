...
export function SuperSeteGenerator({ history }: { history: DrawNumbers[] }) {
  ...
  return <main className={styles.page}>
    <header className={styles.header}><div><span className="eyebrow">Gerador de jogos</span><h1>Monte sua Super Sete.</h1><p>São sete colunas independentes, de 0 a 9. Cada coluna precisa ter ao menos uma marcação.</p></div><span>{history.length} concursos na base</span></header>
