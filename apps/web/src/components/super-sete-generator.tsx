...
export function SuperSeteGenerator({ history }: { history: DrawNumbers[] }) {
  ...
  function generate() {
    try { setTickets(generateSuperSeteTickets({ quantity, total, mode: history.length ? "mixed" : "pure", history, rules: emptyRules })); setError(null); setCopied(false); }
  ...
  return <main className={styles.page}>
    ...
    <div className={styles.layout}><div className={styles.controls}>
      ...
      <p className={styles.priceNote}>{history.length ? "Distribuição automática equilibrada por coluna, com apoio do histórico." : "Distribuição aleatória e independente em cada coluna."}</p>
