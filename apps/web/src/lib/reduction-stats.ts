...
export const reductionGuarantees: Record<string, GuaranteeRow[]> = {
  ...
  "dia-de-sorte:any4-14": [{ inPool: 7, hits: 5 }, { inPool: 6, hits: 4 }, { inPool: 5, hits: 4 }, { inPool: 4, hits: 4 }],
  ...
  "dia-de-sorte:any5-11": [{ inPool: 7, hits: 5 }, { inPool: 6, hits: 5 }, { inPool: 5, hits: 5 }, { inPool: 4, hits: 4 }],
